...
### Contact
When you ask support (at the [discord](https://d.sm0ke.org/) or at the [support chat](/support ':ignore')) you should include the following:  
- Headset (Quest 2, 3, 3s)
- Version (1.37.0, 1.40.8, etc.)
    - Look down in the main menu to find it.
